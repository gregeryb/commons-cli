...
public abstract class ParserTestCase
{
    ...
    public void testAmbiguousLongWithoutEqualSingleDash() throws Exception
    {
        ...
        final Options options = new Options();
        options.addOption(Option.builder("f").longOpt("foo").optionalArg(true).hasArg().build( ));
        options.addOption(Option.builder("b").longOpt("bar").optionalArg(true).hasArg().build( ));
    ...
    public void testUnambiguousPartialLongOption3() throws Exception
    {
        ...
        final Options options = new Options();
        options.addOption(Option.builder().longOpt("verbose").optionalArg(true).hasArg().build());
        options.addOption(Option.builder().longOpt("help").build());
    ...
    public void testAmbiguousPartialLongOption3() throws Exception
    {
        ...
        final Options options = new Options();
        options.addOption(Option.builder().longOpt("version").build());
        options.addOption(Option.builder().longOpt("verbose").optionalArg(true).build());
